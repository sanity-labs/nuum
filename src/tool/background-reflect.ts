...
export const BackgroundReflectTool = Tool.define<typeof parameters, BackgroundReflectMetadata>(
  "background_reflect",
  {
    ...
    async execute({ question }, ctx) {
      ...
      const storage = (ctx as Tool.Context & { extra: BackgroundReflectToolContext }).extra?.storage
      ...
      log.info("spawning background reflection", { taskId, question: question.slice(0, 50) })
