...
export const CancelTaskTool = Tool.define<typeof parameters, CancelTaskMetadata>(
  "cancel_task",
  {
    ...
    async execute({ taskId }, ctx) {
      ...
      const tasksStorage = (ctx as Tool.Context & { extra: CancelTaskToolContext }).extra?.tasks
