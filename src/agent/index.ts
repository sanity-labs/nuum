...
async function surfaceBackgroundReports(storage: Storage): Promise<void> {
  ...
  for (const report of reports) {
    ...
    const reportContent = formatBackgroundReport(
      report.subsystem,
      report.report,
    )
 ...
 */
function formatBackgroundReport(
  subsystem: string,
  ...
  switch (subsystem) {
    ...
    case 'distillation': {
      ...
      if (r.tokensBefore && r.tokensAfter) {
        ...
        lines.push(
          `- Reduced from ${r.tokensBefore.toLocaleString()} to ${r.tokensAfter.toLocaleString()} tokens (saved ${saved.toLocaleString()})`,
        )
      }
      if (r.distillationsCreated) {
        lines.push(
          `- Created ${r.distillationsCreated} distillation${r.distillationsCreated > 1 ? 's' : ''}`,
        )
      }
      return lines.join('\n')
    }
...
function summarizeToolResult(toolName: string, result: string): string {
  ...
  // Format size info
  const sizeInfo = bytes < 1024 ? `${bytes}b` : `${(bytes / 1024).toFixed(1)}kb`
...
interface ToolContextFactory {
  ...
  createReflectContext(
    callId: string,
  ): Tool.Context & {extra: ReflectToolContext}
  createResearchContext(
    callId: string,
  ): Tool.Context & {extra: ResearchToolContext}
  createListTasksContext(
    callId: string,
  ): Tool.Context & {extra: ListTasksToolContext}
}
...
function buildTools(
  ...
  const factory = createToolContextFactory(
    storage,
    sessionId,
    messageId,
    abortSignal,
  ...
  tools.bash = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('bash', () =>
        BashTool.definition.execute(args, factory.createContext(toolCallId)),
      ),
  })
  ...
  tools.read = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('read', () =>
        ReadTool.definition.execute(args, factory.createContext(toolCallId)),
      ),
  })
  ...
  tools.write = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('write', () =>
        WriteTool.definition.execute(args, factory.createContext(toolCallId)),
      ),
  })
  ...
  tools.edit = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('edit', () =>
        EditTool.definition.execute(args, factory.createContext(toolCallId)),
      ),
  })
  ...
  tools.glob = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('glob', () =>
        GlobTool.definition.execute(args, factory.createContext(toolCallId)),
      ),
  })
  ...
  tools.grep = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('grep', () =>
        GrepTool.definition.execute(args, factory.createContext(toolCallId)),
      ),
  })
  ...
  tools.web_search = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('web_search', () =>
        WebSearchTool.definition.execute(
          args,
  ...
  tools.web_fetch = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('web_fetch', () =>
        WebFetchTool.definition.execute(
          args,
          factory.createContext(toolCallId),
        ),
      ),
  ...
  tools.present_set_mission = tool({
    ...
    parameters: z.object({
      mission: z
        .string()
        .nullable()
        .describe('The mission to set, or null to clear'),
    }),
  ...
  tools.present_set_status = tool({
    ...
    parameters: z.object({
      status: z
        .string()
        .nullable()
        .describe('The status to set, or null to clear'),
    }),
  ...
  tools.ltm_glob = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('ltm_glob', () =>
        LTMGlobTool.definition.execute(
          args,
          factory.createLTMContext(toolCallId),
        ),
      ),
  })
  ...
  tools.ltm_search = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('ltm_search', () =>
        LTMSearchTool.definition.execute(
          args,
          factory.createLTMContext(toolCallId),
        ),
      ),
  ...
  tools.ltm_read = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('ltm_read', () =>
        LTMReadTool.definition.execute(
          args,
          factory.createLTMContext(toolCallId),
        ),
      ),
  ...
  tools.list_tasks = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('list_tasks', () =>
        ListTasksTool.definition.execute(
          args,
          factory.createListTasksContext(toolCallId),
        ),
      ),
  })
  ...
  tools.set_alarm = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('set_alarm', () =>
        SetAlarmTool.definition.execute(
          args,
          factory.createListTasksContext(toolCallId),
        ),
      ),
  ...
  tools.background_research = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('background_research', () =>
        BackgroundResearchTool.definition.execute(
          args,
          factory.createResearchContext(toolCallId),
        ),
      ),
  })
  ...
  tools.background_reflect = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('background_reflect', () =>
        BackgroundReflectTool.definition.execute(
          args,
          factory.createReflectContext(toolCallId),
        ),
      ),
  })
  ...
  tools.cancel_task = tool({
    ...
    execute: async (args, {toolCallId}) =>
      safeExecute('cancel_task', () =>
        CancelTaskTool.definition.execute(
          args,
          factory.createListTasksContext(toolCallId),
        ),
      ),
...
export async function runAgent(
  ...
  if (tokensBefore > hardLimit) {
    ...
    log.error('context overflow - refusing turn', {
      tokens: tokensBefore,
      hardLimit,
    })
    throw new Error(
  ...
  if (tokensBefore > softLimit) {
    ...
    if (tokensAfter > softLimit) {
      ...
      log.info('pre-turn compaction successful', {
        before: tokensBefore,
        after: tokensAfter,
      })
    }
  ...
  runMemoryCuration(storage)
      ...
      if (curationResult.ran) {
        if (curationResult.consolidation?.ran) {
          onEvent?.({
            type: 'consolidation',
            content:
              curationResult.consolidation.summary ||
    ...
    .catch((error) => {
      log.error('background memory curation failed', {
        error: error instanceof Error ? error.message : String(error),
      })
    })
